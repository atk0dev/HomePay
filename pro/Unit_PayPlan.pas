...
type
  TFormPayplan = class(TForm)
    ...
    gridPays: TcxGrid;
    gridPaysDBTableView1ID: TcxGridDBColumn;
    gridPaysDBTableView1P_TIME: TcxGridDBColumn;
    gridPaysDBTableView1P_PAYNAME: TcxGridDBColumn;
    gridPaysDBTableView1P_SUMMA: TcxGridDBColumn;
    gridPaysDBTableView1T_MONTH: TcxGridDBColumn;
    gridPaysDBTableView1T_YEAR: TcxGridDBColumn;
    gridPaysDBTableView1TXT: TcxGridDBColumn;
    gridPaysDBTableView1P_NAME: TcxGridDBColumn;
    gridPaysDBTableView1P_TXT: TcxGridDBColumn;
...
uses Unit_DM, Unit_PlanEdit, Unit_Main;
...
//  add
  ...
  FormMain.RefreshDataInForm('На сегодня');
  FormMain.RefreshDataInForm('Платежи');
end;
...
begin
 if MessageDlg('Удалить платеж № ' + qry.FieldByName('id').AsString,
  ...
  begin
    ...
    spDel.ParamByName('userid').Value := DM.UserId;
    spDel.ExecProc;
    LoadData;
    FormMain.RefreshDataInForm('На сегодня');
    FormMain.RefreshDataInForm('Платежи');
