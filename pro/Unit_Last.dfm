object FormLast: TFormLast
  ...
  object Panel1: TPanel
    ...
    object pnlLeft: TPanel
      ...
      object Label3: TLabel
        ...
        Width = 107
        Height = 13
        Caption = #1044#1086#1083#1075' '#1074' '#1101#1090#1086#1084' '#1084#1077#1089#1103#1094#1077':'
      end
      ...
      object edtDolg: TcxCurrencyEdit
        Left = 188
        Top = 121
        Properties.DisplayFormat = ',0.00;-,0.00'
        Properties.ReadOnly = True
    ...
    object cxGrid2DBTableView1: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          ...
          Kind = skSum
          FieldName = 'dolg_prev'
          Column = cxGrid2DBTableView1dolg_prev
        end
        item
          Format = ',0.00;-,0.00'
          Kind = skSum
          FieldName = 'dolg_curr'
          Column = cxGrid2DBTableView1dolg_curr
        end>
      DataController.Summary.SummaryGroups = <>
  ...
  object qry: TIBQuery
    ...
    SQL.Strings = (
      ...
      'select pn.id, pn.p_name,'
        ...
        'e=pn.id and tbl_plan.userid = :userid) as pl_prev,'
      
        '(select sum(p_summa) from tbl_fact where p_time<:tm and p_paynam' +
        'e=pn.id and tbl_fact.userid = :userid) as ft_prev,'
      
        '(select sum(p_summa) from tbl_plan where p_time=:tm and p_paynam' +
        'e=pn.id and tbl_plan.userid = :userid) as pl_curr,'
      
        '(select sum(p_summa) from tbl_fact where p_time=:tm and p_paynam' +
        'e=pn.id and tbl_fact.userid = :userid) as ft_curr'
      ''
      'from tbl_payname pn'
      'where pn.p_userid = :userid'
      'order by pn.p_name')
    Left = 140
    Top = 268
    ParamData = <
  ...
  object qryNeedPay: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select sum(p_summa) from tbl_plan where tbl_plan.p_time = :tm an' +
        'd tbl_plan.userid = :userid')
    Left = 360
    Top = 236
    ParamData = <
      item
  ...
  object qryAlreadyPay: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select sum(p_summa) from tbl_fact where tbl_fact.p_time = :tm an' +
        'd tbl_fact.userid = :userid')
    Left = 356
    Top = 296
    ParamData = <
      item
